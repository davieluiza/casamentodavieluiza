    ...
    return (
       ...
       segue nossa lista de presente."
            ...
            >
                ...
                <SmText>
                    <br/>
                    <b>nos presenteie diretamente (pix): </b>
                </SmText>
                <p className="md-text" style={{color: "#E91E63", margin: 0, fontFamily: "Lora, sans-serif"}}>
                    02220866297 (CPF)
                </p>
                <SmText>
                    Davi da Silva Martins <br/>
                    Banco do Brasil
                </SmText>
                <ListGroup className="p-2 mb-5 d-flex align-items-center p-4">
                    <GiftCard
                        value="R$ 50,00"
                        link="https://mpago.li/1t3PjHT"
                    ...
                    <GiftCard
                        value="Outro valor"
                        link="http://link.mercadopago.com.br/dlcasorio"
                        description="Outro presente"
